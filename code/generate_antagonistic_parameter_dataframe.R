# this script generates the initial parameters to run the coevolution model on a set of 
# antagonistic networks of interactions. The script will generate a csv file with the generated 
# parameters

# define the directory where networks are stored
...
# define the number of replicates that will be run (the number of different parameter combinations
# to define per network)
n_replica <- 100

# define function to generate parameters
generate_parameter_dataframe <- function(network_directory, net_files, n_replica){
    ...
    dir.create('~/indirect_effects_transition_mutualism_antagonism/data/parameters', showWarnings = FALSE)
    # Save file
